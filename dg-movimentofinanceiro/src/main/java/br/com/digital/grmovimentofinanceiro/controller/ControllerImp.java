...
import br.com.digital.grmovimentofinanceiro.dtos.PessoaDTO;
...
import br.com.digital.grmovimentofinanceiro.services.utils.FilesService;
import br.com.digital.grmovimentofinanceiro.services.utils.UtilParameter;
...
public class ControllerImp<T extends BaseEntity> implements Serializable {
	...
	public ResponseEntity<Page<BaseDto>> findPage(@RequestParam(value = "name", defaultValue = "") String name,
			Pageable pageable) {
