...
import br.com.digital.gruposfinanceiro.services.exceptions.AuthorizationException;
...
//					//Escrever Valor destino
	...
	public static BaseEntity complemenForm(BaseEntity banco, BaseEntity formulario, Class classe) {
		...
		/*
		 * if (banco == null) try { banco = (Serializable) classe.newInstance(); } catch
		 * (InstantiationException | IllegalAccessException e1) { // TODO Auto-generated
		 * catch block e1.printStackTrace(); } this.banco = banco;
		 */
	...
	public static Serializable _clonarentity_excludfield(Serializable fonte, Serializable destino, String campos) {
